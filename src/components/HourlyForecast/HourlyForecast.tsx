...
export const HourlyForecast: FC<HourlyForecastProps> = ({
  ...
  const [areScrollControlsVisible, setAreScrollControlsVisible] = useState({
    left: false,
    right: false,
  });
  ...
  const onLeftClick = useCallback(() => {
    listRef.current?.scrollTo({
      left: listRef.current.scrollLeft - SCROLL_DELTA,
      behavior: 'smooth',
    });
  ...
  return (
    <div className={classNames(s.forecast, className)}>
